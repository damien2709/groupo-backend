...
module.exports = (app) => {
  app.put('/api/posts/:id', (req, res) => {
    ...
    // Ici je gère l'erreur 500 de la requête 'update' qui pourrait ne pas aboutir + l'éventuelle erreur de la requête "findByPk" transmise à ce bloc catch grace à son instruction "return".
    .catch(error => {
